...
| ---- | ---- | ---- | ---- |
| `chmod_change_mode_tool` | Change the permissions of a file or directory | - `host`: Remote hostname/IP (optional for local operations)<br>- `mode`: Permission mode (e.g., 755, 644, etc.)<br>- `file`: Target file or directory path | Boolean value indicating whether the operation was successful |
